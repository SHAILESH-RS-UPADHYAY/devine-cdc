...
export function FounderSection() {
  ...
  return (
    <section className="pt-16 pb-12 bg-gray-50/30 relative overflow-hidden" id="founder">
      ...
      <div className="container mx-auto px-4 md:px-6 relative z-10 py-8">
          ...
          className="flex flex-col lg:flex-row items-center gap-8 lg:gap-16 p-8 md:p-12 lg:p-16 rounded-[3rem] bg-white/40 backdrop-blur-3xl border-2 border-brand-pink/50 shadow-[0_0_50px_rgba(255,105,180,0.3)] w-full max-w-7xl mx-auto glass-card relative group"
        >
          {/* Subtle colorful glow that follows the box */}
          <div className="absolute inset-0 bg-gradient-to-tr from-brand-pink/20 via-brand-purple/10 to-brand-yellow/20 opacity-0 group-hover:opacity-100 transition-opacity duration-1000 rounded-[3rem] -z-10 blur-xl"></div>
          ...
          <div className="w-full lg:w-1/2 flex justify-center lg:justify-end">
            <div className="relative w-full max-w-[380px] lg:max-w-[450px] mx-auto lg:mx-0">
              ...
              <motion.div 
                ...
                className="absolute inset-0 bg-gradient-to-tr from-brand-purple via-brand-pink to-brand-yellow rounded-[2.5rem] opacity-50 blur-2xl"
              />
              <motion.div 
                animate={{ scale: [1.02, 1.05, 1.02], rotate: [-2, -4, -2] }}
                transition={{ duration: 5, repeat: Infinity, ease: "easeInOut", delay: 1 }}
                className="absolute inset-0 bg-gradient-to-bl from-brand-blue via-brand-purple to-brand-pink rounded-[2.5rem] opacity-50 blur-xl"
              />
